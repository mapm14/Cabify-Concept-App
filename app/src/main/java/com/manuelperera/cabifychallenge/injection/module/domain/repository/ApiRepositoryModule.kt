...
class ApiRepositoryModule {
    ...
    @Provides
    @Singleton
    fun estimateApiRepository(estimateApiClient: EstimateApiClient<Estimate>,
                              estimateTransactionRequestFactory: TransactionRequestFactory<Estimate>): EstimateApiRepository<Estimate> =
